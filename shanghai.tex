...
%%%%%%%%%%%%%%%%%% HEADING %%%%%%%%%%%%%%%%%%
\title[A function--sheaf dictionary for local tori]{A function--sheaf dictionary for algebraic tori over local fields}
\date{\today}
...
Motivated by the function--sheaf dictionary for commutative, connected
...
In Part 2 we use Theorem~\ref{thm:snake} to make a function--sheaf dictionary
...
is a direct generalization of the function--sheaf dictionary to the case of certain commutative
...
See
\citelist{
\cite{demazure-gabriel:GroupesAlgebriques}*{V, \S 4, no. 1} \cite{bosch-lutkebohmert-reynaud:NeronModels}*{Ch. 9, \S 6} 
...
The first part of Proposition~\ref{prop:pullback} shows that $F_1$ is a functor,
while the second part shows that trace of Frobenius is a natural transformation
$t_{ - ,n} : F_1 \to F_2$. When further combined with Proposition~\ref{prop:product},
