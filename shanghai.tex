...
as functor from the category of schemes locally of finite type 
over an Artinian local ring $A$ with perfect residue field $k$ 
to the category of schemes locally of finite type over $k$. 
This functor enjoys many pleasing properties: 
it respects open immersions, closed immersions, 
...
\[
%\begin{tikzcd}
\Gr_d : \left( \text{Schemes} \atop \text{lft over $\OK$}\right) \to \left( \text{Schemes} \atop \text{lft over $\OK$}\right)
%\end{tikzcd}
\]
