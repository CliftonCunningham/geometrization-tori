...
sheaves). The isomorphism $\mu : \bm^* \gcs{L} \to \gcs{L}\boxtimes\gcs{L}$
...
\begin{proof}
  ...
  $(\bfxf)^*(\LxL) \iso \bf^*\gcs{L} \boxtimes \bf^*\gcs{L}$
...
\begin{proof}
  ...
  arrow, above) of $A\times A$; that is, define $A\times A\to \EEx$
  by the composition of $A\times A \to A$ and $\psi : A\to \EEx$.
  Note that this character is $\psi \otimes \psi : A\times A\to \EEx$.
  ...
  $\mu^0 : \bm_0^* \gcs{E} \to \gcs{E}\boxtimes \gcs{E}$
