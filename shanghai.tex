...
Weil restriction is also compatible with the Greenberg transform, in the following sense: if $e$ is the ramification degree of $K'/K$ then
...
To see this, we employ the functor of points perspective. Let $R$ be any $\Fq$-algebra. Then 
\[
\begin{aligned}
