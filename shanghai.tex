...
\begin{proof}
 ...
 This defines the functor $B_G^* : (\qcs{L}_0,\mu_0) \mapsto (b_G^*\qcs{L}_0,\mu, \phi)$
...
see Section~\ref{sec:snake} for more details regarding this point.
...
isogeny onto $G$ such that the component group of the covering space is isomorphic
