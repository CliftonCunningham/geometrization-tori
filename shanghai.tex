...
\Clifton{Do you think it's clear that a morphism of $\QC$-schemes is, in particular, a morphism of group schemes?}
Let us say that a morphism $f : H\to G$ of $\QC$-schemes is a \emph{discrete isogeny} if it is finite, surjective and etale and the action of $\Gal(\bFq/\Fq)$ on the \'etale group scheme $\ker f \ceq f^{-1}({\bar e)}$ is trivial.
...
for each $n$ by $F_n(\qcs{L}) \ceq [\qcs{L}_n]$ and $F_n(\alpha_n) \ceq [\alpha_n]$. \David{Conflict of notation: we've defined $F_1$ and $F_2$ twice}
