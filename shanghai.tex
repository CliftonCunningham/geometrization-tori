...
namely, a morphism in $C(G)[W^{-1}]$ is the equivalence class of 
 ...
 and $(\beta_1,U_1) : (f_1,\psi_1) \to (f',\psi')$ is a weak isomorphism in $C(G)$.
...
\begin{proof}
 ...
 Factoring along $C_1(G) \to \QCb(G)$ will produce the full and faithful monoidal functor we seek.
   ...
   \Clifton{Is this confusing? Is it clear to what $\Loc(G)$ refers?}
