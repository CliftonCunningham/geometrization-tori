...
In Section \ref{sec:GAN} we introduce N\'eron models of tori and the Greenberg transform, which produce
...
\begin{proof}
  ...
  sum of cyclic $\ZZ[\Gamma_m]$-modules \cite{brandal:CommRingsFGModDecompose}*{?}, each of the
...
We recall the notion of $N$-congruent tori from  \cite{chai-yu:01a}*{\S 2}.  Suppose $T$ and $T'$
...
They then prove the following theorem \cite{chai-yu:01a}*{Thm. 8.5}
