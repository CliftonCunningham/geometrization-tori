...
respect to $d$, we also .....  \Clifton{I'll come back to working on
  ...
  you took this cup from my lips, though.}  
%In particular, by
...
\labitem{(CS.1)}{CS.1} $\mu: \bm^* \gcs{L} \to \LxL$
  ...
  \[
  \xymatrix{
    \bm_3^*\gcs{L} \ar[rr]^{(\bm \tight{1}{\times}{2} \id)^*\mu} \ar[d]_{(\id \tight{2}{\times}{1} \bm)^*\mu}
    &&  \bm^*\gcs{L} \boxtimes \gcs{L} \ar[d]^{\mu \boxtimes \id} \\
    \gcs{L} \boxtimes \bm^* \gcs{L} \ar[rr]^{\id \boxtimes \mu}
...
\labitem{(CS.3)}{CS.3} if $\cs{L} = (\gcs{L},\mu,F)$ and
  ...
  && \LxL \ar[r]^{\varphi\boxtimes \varphi} & \gcs{L'} \tight{0}{\boxtimes}{0} \gcs{L'}\\
  }
  \]
  both commute.
\end{enumerate}
...
\[
\xymatrix{
V & \Aut(V) & 1 \ar[r] & \ar@/_2pc/[ll]^{\psi} \ker \pi \ar[r] & H \ar[r]^{\pi} & G \ar[r] &1 
}
\]
\labitem{(CSb.1)}{CSb.1}
...
\[
\xymatrix{
V \ar[dd] & \Aut(V) \ar@{=}[dd] & 1 \ar[r] & \ar@/^2pc/[ll]_{\psi} \ker \pi \ar[r] & H \ar[r]^{\pi} & G \ar[r] &1\\
 &  & 1 \ar[r] & \ar[u] \ar[d] \ker \pi \ar[r] & \ar[u] \ar[d] H_1 \ar[r]^{\pi_1} & \ar@{=}[u] \ar@{=}[d] G \ar[r] &1\\
V' & \Aut(V) & 1 \ar[r] & \ar@/_2pc/[ll]^{\psi'} \ker \pi' \ar[r] & H' \ar[r]^{\pi} & G \ar[r] &1\\ 
}
\]
\end{enumerate}
...
\begin{proof}
  ...
  \begin{equation}\label{E}
    \xymatrix{
      \EEx & 1\ar[r] & \ar@/_1pc/[ll]_{\psi} A  \ar[r] & B \ar[r]^{\pi} & G^0 \ar[r] & 1\\
      }
  \end{equation}
  ...
  \EEx & 1 & A & B & G^0 & 1 \\
  & 1 & \AxA & \BxB & \GzxGz & 1\\ };
  %\foreach \x in {2,3,4,5} \let \x1={\x+1} 
  %\draw [->] (m-1-\x) -- (m-1-\x1);
  \end{tikzpicture}
  \end{center}
  ...
  \begin{equation}
    \xymatrix{
      \EEx & 1\ar[r] & \ar@/_1pc/[ll]_{\psi} A  \ar[r] & B \ar[r]^{\pi} & G^0 \ar[r] & 1\\
      & 1\ar[r] & \ar@{.>}@/^1pc/[llu] \ar[u] \AxA  \ar[r]
      & \ar[u]^{m_{B}} \BxB \ar[r]^{\pi\tight{1}{\times}{1} \pi}  & \ar[u]^{m_0} \GzxGz \ar[r] & 1\\
      }
  \end{equation}
  ...
  B & H & \pi_0(H) \\
  G^0 & G & \pi_0(G) \\};
  \draw [double equal sign distance] (m-1-1) -- (m-1-2);
  \draw [->] (m-1-1) -- (m-2-1);
  \draw [->] (m-2-1) -- (m-2-2);
  \draw [->] (m-1-2) -- (m-2-2);
  \draw [->] (m-2-1) to node[label,swap] {$\pi$} (m-3-1);
  \draw [->] (m-3-1) -- (m-3-2);
  \draw [->] (m-2-2) to node[label,swap] {$f$} (m-3-2);
  \draw [->] (m-2-2) -- (m-2-3);
  \draw [->] (m-3-2) -- (m-3-3);
  \draw [->] (m-2-3) to node[below,rotate=90] {$\sim$} node[label,swap] {$\pi_0(f)$} (m-3-3);
  \end{tikzpicture}
  \end{center}
  ...
  & B \\
  I & A \\};
  \draw [right hook->] (m-2-2) -- (m-1-2);
  \draw [->] (m-2-2) to node[swap,label] {$a$} (m-2-1);
  \end{tikzpicture}
  \end{center}
  ...
  \node (0) at (0,0) {$\EEx$};
  \node (1) [anchor=east] at (7,0) {$\Aut(\bf^x) \times \Aut(\bf^y)$};
  \node (2) [anchor=west] at (7.4,0) {$\bH^x \times \bH^y$};
  \node (3) at (12,0) {$\bG^x \times \bG^y$};
  \draw [->] (1) to node[swap, label] {$\psi_x \otimes \psi_y$} (0);
  \draw [->] (7.3,-0.06) arc (330:40:0.12) -- (7.3,0.07);
  ...
  \node (12) [anchor=east] at (4,2) {$\Aut(\bf^{x+y})$};
  \node (22) [anchor=west] at (4.4,2) {$\bH^{x+y}$};
  \node (32) [anchor=east] at (11,2) {$\bG^{x+y}$};
  \node (01) at (0,1) {$\EEx$};
  \node (11) [anchor=east] at (4,1) {$\Aut(\bf^{x+y})$};
  \node (21) [anchor=west] at (4.4,1) {$\bH^{x+y} \times_{\bG^x\times\bG^y} \bG^x\times\bG^y$};
  \node (31) [anchor=east] at (11,1) {$\bG^x\times \bG^y$};
  \node (10) [anchor=east] at (4,0) {$\Aut(\bf^x)\times \Aut(\bf^y)$};
  \node (20) [anchor=west] at (4.4,0) {$\bG^x\times \bG^y$};
  \node (30) [anchor=east] at (11,0) {$\bG^x\times \bG^y$};
  \draw [->] (4.3,1.94) arc (330:40:0.12) -- (4.3,2.07);
  \draw [->, densely dotted] (4.3,0.94) arc (330:40:0.12) -- (4.3,1.07);
  \draw [->] (4.3,-0.06) arc (330:40:0.12) -- (4.3,0.07);
  \draw [->] (12) to node[swap,label] {$\psi_{x+y}$} (01);
  \draw [->, densely dotted] (11) -- (01);
  \draw [->] (10) to node[label] {$\psi_x \otimes \psi_y$} (01);
  \draw [->, densely dotted] ($(11.south) + (0,-0.5)$) -- (11);
  \draw [double equal sign distance] (11) -- (12);
  \draw [->] (22) to node[label] {$\bf^{x+y}$} (32);
  \draw [->] ($(22.south) + (0,-0.5)$) -- (22);
  \draw [->] (21) -- (31);
  \draw [->] ($(32.225) + (0,-0.5)$) to node[swap] {\footnotesize{$\bm_{x,y}$}} (32.225);
  \draw [->] ($(22.south) + (0,-1.5)$) -- ($(22.south) + (0,-1)$);
  \draw [->] (20) to node[label] {$\bf^x \times \bf^y$} (30);
  \draw [->] ($(32.225) + (0,-1.5)$) -- ($(32.225) + (0,-1)$);
  \end{tikzpicture}
  ...
  \[
  \xymatrix{
    && \ar[dll]_{\psi_{\Frob(x)}} \Aut(\bf^{\Frob(x)}) & \ar@(ul,dl)
    & \bH^{\Frob(x)} \ar[rr]^{\bf^{\Frob(x)}} && \bG^{\Frob(x)}\\
    \EEx & & \ar@{.>}[ll] \Aut(\bf^{\Frob(x)})  \ar@{=}[u] & \ar@{.>}@(ul,dl)
    & \ar[u] \bH^{\Frob(x)} \times_{\bG^{\Frob(x)}} \bG^x \ar[rr] && \ar[u]_{\Frob_{x}} \bG^x\\
    & &  \ar[ull]^{\psi_x}  \ar@{.>}[u] \Aut(\bf^{x}) & \ar@(ul,dl)
    & \ar[u] \bH^x \ar[rr] && \ar@{=} [u] \bG^x\\
    }
  \]
...
\[
\xymatrix{
\CS(\GN{T}) \ar[d] & \CSiso{\GN{T}} \ar[r]^{t_T} \ar[d] & \Hom_\text{ad}(T(K),\EEx) \ar[d] \\
\CS(\GN{T}') & \CSiso{\GN{T}'} \ar[r]^{t_{T'}} & \Hom_\text{ad}(T'(K),\EEx)\\
}
\]
\end{proposition}
