...
non-connected groups he restricts his attention to reductive groups with cyclic component group. If commutative, such groups are extensions of $\ZZ/n\ZZ$ by a torus,
in which case is not difficult to relate his Frobenius-stable character sheaves to our quasicharacter sheaves.
...
%\Clifton{Now I wonder if $f_{n\leq m}$ is a discrete isogeny!!!  What's the covering group of $f_{n\leq m}$?  Must be the finite group $\GN{T}_{m}(\Fq)/\GN{T}_n(\Fq)$, which could be $\TT^0(\pK^n/\pK^{m})$. We might be able to build some very special finite quasicharacter sheaves on $\GN{T}_n$ this way.}
...
Passing to isomorphism classes of objects and invoking the universal property of $\varinjlim_{d\in \ZZ_{>0}} \QCiso{\GN{T}_d}$ gives a group homomorphism
$\theta: \varinjlim_{d\in \ZZ_{>0}} \QCiso{\GN{T}_d} \to \QCiso{\GN{T}}$; this is a bijection 
