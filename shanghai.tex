...
local Langlands correspondence \cite{reeder-debacker:09a}.  The next step Lusztig took in studying representations
...
Let $\Frob{\Fq}$ denote the geometric Frobenius element in $\Gal(\bFq/\Fq)$ as well as the corresponding automorphism of $\Spec{\bFq}$, and let $\Frob{G} := \id_{G} \times \Frob{\Fq}$ be the Frobenius automorphism of $\bG$.  \David{add definition of Weil groups}
