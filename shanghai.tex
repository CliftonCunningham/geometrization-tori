...
%  \end{equation}
 ...
 and $(h,U) :  (f',\psi') \to (f_1,\psi_1)$ is a weak isomorphism in $C(G)$; see \cite{kashiwara-schapira:CatgoriesSheaves}*{Thm 7.1.16} for more detail, including the equivalence relation mentioned above.
...
\Clifton{The finitely generated part of the hypothesis is unnecessary.}
