...
A \cdef{geometrized character on $G$} is a triple
...
%
  ...
  \]
\end{enumerate}
Morphisms in the category of geometrized characters of $G$, denoted by \cdef{$\GC(G)$}, are defined in the natural way:
\begin{enumerate}
