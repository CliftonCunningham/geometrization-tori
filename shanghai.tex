...
$\Frob{\Spec{\bFq}} = \Spec\Frob{\Fq}$ and $\Frob{\Fq}$  is the geometric Frobenius element in $\Weil{\Fq} \subset \Gal(\bFq/\Fq)$.
...
%
  ...
  \begin{equation}\label{t}
    \forall x\in G(\bFq),\qquad F_{x}(s(\Frob{\Fq}(x)) = \tau_\cs{L}(\Frob{\Fq})(x) s(x).
  \end{equation}
