...
\cite{bertrapelle-gonzales}
}
for the definition and fundamental properties of the Greenberg functor. 
...
\begin{proof}
This follows from \cite{bertrapelle-gonzales:Greenberg}*{Prop. 6.3} after observing that 
\end{proof}
