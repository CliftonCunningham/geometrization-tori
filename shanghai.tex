...
\begin{proof}
The main issue to address is well-definedness. Although the pull-back appearing in the diagram above it not unique, the recipe for $g^*$ is well-defined as a functor between localized categories.
To see this, recall that a morphism in $\GCf(G)$ is an equivalence class of a diagram like \eqref{eq:morGCf}, commonly denoted by $(\alpha_1,T_1)^{-1}\circ (\alpha'_1,T'_1)$. 
