...
\begin{proof}
  ...
  \draw [->] (4.3,1.94) arc (330:30:0.12);
  \draw [->, densely dotted] (4.3,0.94) arc (330:30:0.12);
  \draw [->] (4.3,-0.06) arc (330:30:0.12);
  \draw [->] (12) to node[swap] {\footnotesize{$\psi_{x+y}$}} (01);
  \draw [->, densely dotted] (11) -- (01);
  \draw [->] (10) to node {\footnotesize{$\psi_x \otimes \psi_y$}} (01);
  \draw [->, densely dotted] ($(11.south) + (0,-0.5)$) -- (11);
  \draw [double equal sign distance] (11) -- (12);
  \draw [->] (22) to node {\footnotesize{$\bf^{x+y}$}} (32);
  \draw [->] ($(22.south) + (0,-0.5)$) -- (22);
  \draw [->] (21) -- (31);
  \draw [->] ($(32.south) + (0,-0.5)$) to node[swap] {\footnotesize{$\bm_{x,y}$}} (32);
  \draw [->] ($(22.south) + (0,-1.5)$) -- ($(22.south) + (0,-1)$);
  \draw [->] (20) to node {\footnotesize{$\bf^x \times \bf^y$}} (30);
  \draw [->] ($(32.south) + (0,-1.5)$) -- ($(32.south) + (0,-1)$);
  \end{tikzpicture}
