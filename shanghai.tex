...
Let $\pi: B \to G^0$ be a discrete isogeny and set $A \ceq \ker \pi$.
  ...
  \]
  Since finite fields have cohomological dimension $1$ \cite{serre:GaloisCohomology}*{\S II.3.3},
  $\Ext^2_{\ZZ[\Gamma]}(\pi_0(G)(\bFq), A(\bFq))$ vanishes \cite{cartan-eilenberg:HomologicalAlgebra}*{Thm. 2.6}.
