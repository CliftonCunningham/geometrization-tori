...
For each positive integer $d$, the trace of Frobenius 
  \[
t_{T,d}:  \QCiso{\GN{T}_d} \to \Hom_{< d}(T(K),\EEx)
  \]
is an isomomorphism from the additive functor
\[T \mapsto \QCiso{\GN{T}}\]
...
This gives us a natural way to geometrize all quasicharacters of $T(K)$ without reference to depth.
