...
\item and if the cokernel \David{Is $C(G)$ abelian?} of a morphism $\phi \in \mor C(G)$ is in
...
facts on \'etale covers and pullbacks. \David{Is this sufficient?}
\end{proof}
...
To prove the next proposition, we will need a certain perspective on local systems.
 ...
 we may associate to $\qcs{E}$ a character of the \'etale fundamental group $\pi_1(G, \bg)$ \David{add citation}.
