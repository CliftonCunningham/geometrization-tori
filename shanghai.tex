...
We first begin by defining a category $C(G)$, whose objects consist of pairs $(f,\psi)$ where
\begin{itemize}
...
$\ker f'$ on $V'$ by $\psi'$ and the action of $\ker '$ on $V$ by $\psi \circ \alpha$.
\[
\begin{tikzcd}
...
$\psi \oplus\psi' :  \ker(f\times_G f') \to \Aut(V\otimes V')$
...
\David{Should expand on this a bit and note that $C(G)[W^{-1}]$ admits a calculus of fractions}
