...
in which case is not difficult to relate Frobenius-stable character sheaves to our quasicharacter sheaves.
...
In Section~\ref{sec:GN} we introduce the Greenberg transform of N\'eron models of tori, which produce
