...
it is also an $H$-torsor in the fpqc topology.  It now follows from descent theory that the comparison functor $\Loc(G\ab) \to \Loc_H(G)$ is an equivalence; argue as in \cite{Vistoli:notes}*{Thm 4.46}, for example. \todo{Need to adapt the following proof to the definition of $q\ab^*$.}
