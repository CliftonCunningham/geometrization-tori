...
there are more character sheaves than there are characters. 
...
Hypothesis~\ref{H1a} allows us to use Proposition~\ref{prop:quasicharacters} to geometrize each quasicharacter $\varphi^i$ using local systems on $G_i$, or more precisely, using commutative character sheaves on $G_i$;
alternatively, Hypothesis~\ref{H1b} may be used to geometrize each quasicharacter $\varphi^i$ using an element in the Grothendieck group of perverse sheaves on $G_i$, tensored with ${\bar\QQ}$.
