...
The purpose of the category $\CCS(G)$ is to make this translation from characters $\chi$ to Weil local systems $\cs{L}$ as precise as possible by making $\TrFrob{} : \CCSiso{G} \to G(k)^*$ as close to an isomorphism as possible.
%\end{remark}
