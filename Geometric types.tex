...
\section{Examples of Nontrivial Characters on the Derived Subgroup} \label{sec:badchar}
...
Suppose that $C$ is a stratum and $x \in C$. Local systems on $C$ are classified up to isomorphism by irreducible representations of $\pi_0(Z_G(x))$.  This component group is trivial for $C_3$, $1$ and $-1$, and of order $2$ for $C_2$ and $C_2^-$.  Denote the nontrivial local systems on $C_2$ and $C_2^-$ by $\cs{E}_{C_2}$ and $\cs{E}_{C_2^-}$.  Then the character sheaves on $\SL_2$ are the following, where the second column gives a decomposition in the Grothendieck group of standard sheaves on $G$.

\vspace{0.1in}

\begin{tabular}{|l|l|ccccccc|}
\hline
Perverse & Standard & \multicolumn{7}{|c|}{Trace of Frobenius values} \\ \cline{3-9}

Sheaf & Sheaves & \smat1001 & \smat2002 & \smat0120 & \smat1101 & \smat1201 & \smat2102 & \smat2202 \\
\hline
