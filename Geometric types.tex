...
Let $(\oK^i, \orho^0, \varphi^i)$ be a Yu type datum that satisfies Hypotheses~\ref{H0} and \ref{H1}, and let $\orho_i$ be the representation of $\oK^i$ constructed from it in Section~\ref{ssec:review}.  Then for each $i=0,\dots, d$ there is an element $\cs{F}_i \in \mathcal{K}_{\bar\QQ} D_{G^i}(X)$ such that
\[
