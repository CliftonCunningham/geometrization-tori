...
In particular, any character of any representation of $G(k)$ can be expressed as a ${\bar \QQ}$-linear \todo{should this be $\EE$-linear?} combination of characteristic functions of Weil character sheaves on $G$.
...
We will see an example of this in Section~\ref{ssec:SL23}.
