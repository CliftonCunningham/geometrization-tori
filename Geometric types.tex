...
As proved by Ju-Lee Kim in \cite{kim:07a}, all irreducible supercuspidal representations of tamely ramified $p$-adic groups for sufficiently large $p$ can be built from ``data'' introduced by Jiu-Kang Yu in \cite{yu:01a}*{\S 15}.
...
This result is extended in the papers beginning with \cite{lusztig:disconnected1} to reductive groups $G$ over $k$ for which the geometric component group for $G$ is cyclic.
