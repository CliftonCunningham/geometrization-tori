...
Hypothesis~\ref{H1a} may be used to geometrize each quasicharacter $\varphi_i$ using an element in the Grothendieck group of perverse sheaves on $G_i$, tensored with ${\bar\QQ}$.
