...
The geometrization of the Yu type datum that we consider in this paper uses Lusztig's theory of character sheaves on reductive groups over finite fields, for which it is necessary to assume that the geometric component group of the reductive quotient of the special fibre of the group scheme $\underline{G}^0$ is cyclic. \todo{Descrie these two conditions at the beginning of Section 5 and point to that from here.}
...
Here we explain the hyptheses to the main result of this section, Theorem~\ref{thm:geotypes}.
We have just seen that a Yu type datum, which consists of 
...
From Section~\ref{ssec:equivariant}, recall the definition of a rational virtual equivariant Weil sheaf complex. \todo{!}
