...
We note that this use of the term is compatible with the use of the term {\it quasicharacter} in \cite{Cassels-Frohlich:ANT}*{Ch XV, \S 2.3}.
 \todo{add bibliography entry for Tate's thesis}
...
see \cite{stacks_project:limits}*{Lem 2.2}.
\todo{add bibliography entry for the Stacks project}
