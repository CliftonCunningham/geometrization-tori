...
%\usepackage[numeric,initials]{amsrefs}
...
Mathematics Subject Classification 2010: 14F05 (primary), 14L15 (secondary)
\end{abstract}
...
{\it A priori}, the composition $\qcs{E} \to \qcs{E}' \to \qcs{E}''$ of two such morphisms need not be compatible with the choices of \eqref{introbox} for $\qcs{E}$ and $\qcs{E}''$. % since the choice for $\qcs{E}'$ might differ.  
...
%The fact that $\TrFrob{G}$ may not be an isomorphism should not be too troubling: if quasicharacter sheaves $(\gqcs{L}, \mu,\phi)$ and $(\gqcs{L}', \mu',\phi')$ determine the same character of $G(\Fq)$ then $(\gqcs{L},\phi)$ and $(\gqcs{L}',\phi')$ are isomorphic as Weil sheaves.
...
any local field $K$ with finite residue field $\Fq$ and any commutative algebraic group $X_K$ that admits a N\'eron model $X$. % over $R$, the ring of integers of $K$.
...
for allowing us to hijack much of our Research in Teams meeting at the Banff International Research Station into a discussion of
...
% italicized and
% Bernstein lecture
% Etingof url, preprint note
% Italicized author in D-G appendix
% EGA ordering
% Ravi notes
% Vogan LLC
...
\bib{beilinson-bernstein-deligne:81a}{article}{
   author={\it A. A. Be{\u\i}linson},
   author={\it J. Bernstein},
   author={\it P. Deligne},
   title={\rm Faisceaux pervers},
   journal ={Ast\'erisque},
   volume={100},
...
\bib{bernstein:vogan_conference}{lecture}{
	author = {\it J. Bernstein},
	title = {\rm Stacks in Representation Theory: What is a representation of an algebraic group?},
 note={Lecture delivered at {\it A conference dedicated to David Vogan on his 60th birthday: Representations of reductive groups}}, 
 %\url{http://math.mit.edu/conferences/Vogan/}},
 	date={May, 2014},
 	location={MIT, Boston},
 }
 
 \bib{bernstein-luntz:equivariant_sheaves}{book}{
      author={\it J. Bernstein},
      author={\it V. Luntz},
       title={\rm Equivariant sheaves and functors},
...
\bib{bertrapelle-gonzales:Greenberg}{preprint}{
      author={\it A. Bertrapelle},
      author={\it C.-D. Gonz\'ales-Avil\'es},
       title={\rm The Greenberg functor revisited},
        note={\url{http://arxiv.org/abs/1311.0051}},
      date={2013},
}

\bib{bitan:discriminant}{article}{
      author={\it R. A. Bitan},
       title={\rm The discriminant of an algebraic torus},
        date={2011},
...
\bib{bosch-lutkebohmert-reynaud:NeronModels}{book}{
      author={\it S. Bosch},
      author={\it W. L\"utkebohmert},
      author={\it M. Reynaud},
       title={\rm N\'eron models},
   publisher={Springer-Verlag},
     address={Berlin},
        date={1980},
}

\bib{brown:CohomologyGrps}{book}{
      author={\it K. S. Brown},
       title={\rm Cohomology of groups},
...
\bib{cartan-eilenberg:HomologicalAlgebra}{book}{
      author={\it H. Cartan},
      author={\it S. Eilenberg},
       title={\rm Homological algebra},
   publisher={Princeton U.P.},
     address={Princeton},
        date={1956},
}

\bib{cassels-frohlich:AlgebraicNumberTheory}{book}{
      editor={\it J. W. S. Cassels},
      editor={\it A. Frohlich},
       title={\rm Algebraic number theory},
     edition={2nd ed.,},
...
\bib{chai-yu:01a}{article}{
      author={\it C.-L. Chai},
      author={\it J.-K. Yu},
       title={\rm Congruences of N\'eron models for tori and the Artin
  conductor},
        date={2001},
...
\bib{deligne:80a}{article}{
      author={\it P. Deligne},
       title={\rm La conjecture de Weil II},
        date={1980},
...
\bib{deligne:02a}{article}{
      author={\it P. Deligne},
       title={\rm {Cat\'egories tensorielles}},
        date={2002},
     journal={{Mosc. Math. J.}},
      volume={2},
      number={2},
...
\bib{deligne-katz:SGA7.2}{book}{
      author={\it P. Deligne},
      author={\it N. Katz},
       title={\rm {Groupes de monodromie en g\'eom\'etrie alg\'ebrique. II}},
      series={{Lecture Notes in Mathematics}},
   publisher={{Springer-Verlag}},
     address={Berlin},
        date={1973},
...
\bib{demazure-gabriel:GroupesAlgebriques}{book}{
      author={\it M. Demazure},
      author={\it P. Gabriel},
       title={\rm {Groupes alg\'ebriques. Tome 1: G\'eom\'etrie alg\'ebrique,
  g\'en\'eralit\'es, groupes commutatifs}},
   publisher={{Masson \& Cie}},
     address={Paris},
        date={1970},
        note={(Appendix: {\it M. Hazewinkel}, Corps de classes local)},
}

\bib{etingof:09a}{unpublished}{
      author={\it P. Etingof},
      author={\it S. Gelaki},
      author={\it D. Nikshych},
      author={\it V. Ostrik},
       title={\rm Tensor categories},
        date={2009},
        note={{Lecture notes for MIT's 18.769}, available at \url{http://www-math.mit.edu/~etingof/tenscat.pdf}},
}

\bib{vdGeer-Moonen:AbelianVarieties}{preprint}{
      author={\it G. van der Geer},
      author={\it B. Moonen},
       title={\rm {Abelian varieties}},
        date={2013},
       note={available at \url{http://staff.science.uva.nl/~bmoonen/boek/BookAV.html}},
%        note={Writing in progress.},
}

\bib{greenberg:61}{article}{
      author={\it M. J. Greenberg},
       title={\rm {Schemata over local rings I}},
        date={1961},
     journal={Annals of Math},
      volume={73},
      number={2},
...
\bib{greenberg:63a}{article}{
      author={\it M. J. Greenberg},
       title={\rm {Schemata over local rings II}},
        date={1963},
     journal={Annals of Math},
      volume={78},
      number={2},
...
\bib{EGAIV2}{article}{
      author={\it A. Grothendieck},
       title={\rm {\'El\'ements de g\'eom\'etrie alg\'ebrique. IV. \'Etude locale
...
\bib{EGAIV3}{article}{
   author={\it A. Grothendieck},
   title={\rm{\'El\'ements de g\'eom\'etrie alg\'ebrique. IV. \'Etude locale des
...
\bib{SGA5}{book}{
      author={\it A. Grothendieck},
       title={\rm {S\'eminaire de G\'eom\'etrie Alg\'ebrique du Bois Marie 1965--66
  SGA5: Cohomologie $\ell$-adique et Fonctions L}},
      series={{Lecture Notes in Mathematics}},
   publisher={{Springer-Verlag}},
        date={1977},
      volume={589},
...
\bib{kamgarpour:09a}{article}{
      author={\it M. Kamgarpour},
       title={\rm {Stacky abelianization of algebraic groups}},
        date={2009},
...
\bib{lang:56a}{article}{
      author={\it S. Lang},
       title={\rm{Algebraic groups over finite fields}},
        date={1956},
     journal={Amer. J. Math.},
      volume={78},
       pages={555\ndash 563},
...
\bib{laumon:87a}{article}{
      author={\it G. Laumon},
       title={\rm{Transformation de Fourier, constantes d'\'equations
  fonctionnelles et conjecture de Weil}},
        date={1987},
     journal={{Inst. Hautes \'Etudes Sci. Publ. Math.}},
      volume={65},
       pages={131\ndash 210},
...
\bib{lusztig:disconnected1}{article}{
      author={\it G. Lusztig},
       title={\rm {Character sheaves on disconnected groups. I}},
        date={2003},
...
\bib{nicaise-sebag:motivicSerre}{article}{
      author={\it J. Sebag},
      author={\it N. Nicaise},
       title={\rm{Motivic Serre invariants and Weil restriction}},
        date={2008},
     journal={J. Algebra},
      volume={319},
      number={4},
...
\bib{Vakil:spectral_sequences}{unpublished}{
      author={\it R. Vakil},
       title={\rm{Spectral sequences: friend or foe?}},
        date={2008},
        note={Notes for 216: Foundations of Algebraic Geometry, available at \url{http://math.stanford.edu/~vakil/0708-216/216ss.pdf}},
}

\bib{vogan:93a}{article}{
   author={\it D. A. Vogan},
   title={\rm{The local Langlands conjecture}},
 %  conference={
...
\bib{Weibel:Homological_Algebra}{book}{
      author={\it C. A. Weibel},
       title={\rm{An introduction to homological algebra}},
