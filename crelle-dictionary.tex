...
\end{equation}
\todo{This is dual to Lemma 2.6, and isn't true in general.  Is the fact that $X_*(T_K)$ is torsion-free sufficient?} where $\Weil{K}$ is the Weil group for $K$ and $\check{T}_\ell$ is the $\ell$-adic dual torus to $T_K$.
...
\]
\todo{Is $X(K') = X'(K')$?} Passing to limits now defines
\[ 
