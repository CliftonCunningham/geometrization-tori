...
\end{proposition}
\begin{proof}
This result follows from Propositions~\ref{prop:ses_desc} and \ref{prop:sur_etale}.
\end{proof}

\subsection{Morphisms}\label{ssec:mor-etale}

Most of this paper focuses on the question of determining the isomorphism classes of objects in $\QC{G}$.
A full understanding of the category also requires a description of the morphisms.
...
\begin{proof}
 ...
 Then $\qcs{E}$ \todo{should this be $b_G^* \qcs{E}$?} is an $\ell$-adic constructible sheaf on $G$ and
 ...
 from $\ell$-adic constructible sheaves on $G$ to $\ell$-adic constructible sheaves on $G$ \todo{are the domain and codomain here really supposed to be the same?}
