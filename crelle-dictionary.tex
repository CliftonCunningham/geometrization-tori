...
\begin{abstract}
We extend the function-sheaf dictionary to smooth commutative group schemes over finite fields. 
As an application, we explain how to geometrize and categorify quasicharacters of  algebraic tori, abelian varieties and unipotent K-wound groups over connected commutative algebraic groups over non-Archimedean local fields that admit a Neron model locally of finite type,
\end{abstract}
