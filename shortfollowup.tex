...
for which the structure morphism $G \to \Spec{\Fq}$ is smooth in the sense of \cite{EGA:IV4}*{Def 17.3.1}. This implies $G \to \Spec{\Fq}$ is locally of finite type, but not that it is of finite type.
