...
For any non-archimedean local field $K$
  ...
  function--sheaf dictionary for smooth group schemes over finite type over fields
  to geometrize quasicharacters of $T(K)$
  as quasicharacter sheaves on the Greenberg transform of the Néron
  model of $T$.
 As an application, we categorify a transfer of certain characters between characteristic $p$ tori and characteristic $0$ tori.
  \end{abstract}
...
\begin{proof}
  By \ref{smooth}, we may use \eqref{snake} to produce a canonical isomorphism
