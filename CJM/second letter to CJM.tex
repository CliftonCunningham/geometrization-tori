...
\item The new section also addresses this concern.  Note that the reviewer is correct that $n^*_2(\mu)$ agrees with $p^*_2(\mu)$, though we did not add this fact explicitly to the paper, because it was not needed in the discussion of rigidification.
\end{enumerate}
