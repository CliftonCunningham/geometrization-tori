...
\item[(ii)] Thank you for pointing this out. We replaced all instances of $\O$ with $R$, and declared $R$ to be the ring of integers of a local ring with finite residue field. 
...
\item[(v)] We replaced every instance of $S$ with $\Spec(R)$, which is what we meant by $S$, though we had neglected to say that anywhere.
