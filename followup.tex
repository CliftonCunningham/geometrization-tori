...
Then there is a Weil sheaf $\cs{F}$ on $\Gr(\underline{G})$ such that $\trFrob{\cs{F}} = \trace \chi$.
\end{proposition}
...
Recall from Section~\ref{ssec:models} that the ingredient representations in the construction of any Yu type are:
\begin{enumerate}
...
We now explain how to geometrize the characters of these ingredient representations.
