...
%\todo{I got this wrong. I think our sheaves are not extra information in the commutative case. Masoud's definition is designed to match the definition coming from central extensions, while we have one that matches Ext1 in Ab, in the connected case. So, I think the modification is easy: add mop to diagram 2.4 in Masoud's paper. \\ -CC}
\fi
...
this can be seen by following the argument of \cite{cunningham-roe:13a}].
...
The  isomorphism $\nu_2 : a_2^*\cs{L}_2\to p_2^*\cs{L}_2$ satisfies the appropriate version of \eqref{ECS1}, so  $(\cs{L}_2,\mu_2,nu_2)$ is indeed an $H\times H$-equivariant linear character sheaf on $G\times G$.
