...
\item[(3)] a quasicharacter $\varphi_i : J^i \to \CC^\times$, for $i=0, \ldots d$.
\end{enumerate}
...
%\begin{enumerate}
\item[(11)] a representation $\,^\circ \rho_i$ of $J^0\cdots J^i$, for each $i=0, \ldots, d$, such that $\,^\circ \rho_d = \,^\circ \rho$,
constructed as follows.
%\end{enumerate}
%We will need some more detail about the construction of the representations $\,^\circ \rho^i$, so we review it below.
%
 We will need some detail about this construction, so we will review it here.
