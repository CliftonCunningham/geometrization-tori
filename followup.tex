...
[Every commutative character sheaf on $G$ is equivariant for the conjugation action of $G$ on $G$; conversely, if a linear character sheaf on $G$ is equivariant for conjugation, then it is commutative?]
\end{lemma}
