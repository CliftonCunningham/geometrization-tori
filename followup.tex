...
\todo{Comment here on Masoud's work.}
...
On objects, $q_H^*: \CS(Q)\to \CS_H(G)$ is given by $q_H^*(\cs{L}_0,\mu_0) = (L_1(\cs{L}_0), L_2(\mu_0))$. \todo{Shorten this, actually, and combine with the next paragraph.}
