...
$G(k)^*$, assuming that $G$ is smooth, but not that it is connected, reductive or commutative. \todo{Is there a relationship with Lusztig's character sheaves that we can easily summarize?}
