...
One of the main results of \cite{yu:03a} is that there is a canonical affine smooth group scheme $\underline{G}$ of finite type over $\OK$ such that $\,^\circ K = \underline{G}(\OK)$ \cite{yu:03a}*{Prop 10.2}.
...
\end{enumerate}
From this data, the representation $\,^\circ \rho$ is built as follows, as explained in \cite{yu:03a}*{\S 10.5}.
\begin{enumerate}
\item 
