...
on objects, $q_H^*: \CS(G_0)\to \CS_H(G)$ is given by $q_H^*(\cs{L}_0,\mu_0) = (L_1(\cs{L}_0), L_2(\mu_0))$; on maps, $q_H^*: \CS(G_0)\to \CS_H(G)$ is given by $q_H^*(\alpha_0) = L_1(\alpha_0)$.
...
%
With this description of $q_H^*: \CS(G_0)\to \CS_H(G)$ is is easy to see that it is an equivalence.
