...
By \cite{yu:models}*{Prop 10.2} there is a sequence of morphisms of affine smooth group schemes of finite type over $\OK$
\[
\underline{G}^0 \to \underline{G}^1 \to \cdots \to \underline{G}^d = \underline{G}
\]
such that $\underline{G}^i(\OK) = \,^\circ K^i$ for $i=0,\ldots d$.
Also, for each $i=0,\ldots d$, there is morphism of affine smooth group schemes of finite type over $\OK$ 
\[
\underline{J}^i \to \underline{G}
\] 
such that $\underline{J}^i(\OK) = J^i$ as a subgroup of $\,^\circ K$.
