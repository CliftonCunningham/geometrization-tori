...
\end{align*}
 ...
 \begin{proof}
 By descent along $G \to G/C = G\der$, pullback induces an equivalence of categories between $C$-equivariant local systems on $G$ local systems on  $G\der$. \todo{I need to explain what's going on here. \\ -CC}
