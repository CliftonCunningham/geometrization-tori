...
Thus, $\beta : \cs{L}\vert_{G\der} \to (\EE)_{G\der}$ determines the isomorphism $m^*\cs{L} \otimes \theta^* m^* i^*\cs{L} \to (\EE)_G\otimes (\EE)_G$ by the diagram \todo{Fix this diagram.}
\[
\begin{tikzcd}
...
Pulling back $\cs{L}$ along $m : G\times G \to G$ produces the linear character sheaf $(\cs{L}_2, \mu_2)$ on $G \times G$ (see \cite{cunningham-roe:13a}*{Lemma 1.4}), \todo{False, because $m$ is not a group homorphism.}
