...
Its adjoint is given on objects by $(\cs{L},\mu,\nu) \mapsto (R_1(\cs{L},\nu), R_2(\nu))$, again making use of Lemma~\ref{lem:HH}, and on morphisms by $\alpha \mapsto R_1(\alpha)$.
...
%\end{tikzcd}
%\]
Define $f : H\times G \to G\times G$ by $f(h,g) = (i(h),g)$ and note that $a = m\circ f$.
...
& f^*(\cs{L}\boxtimes \cs{L}) \arrow{r}{p_1 \circ f = i}[swap]{p_2\circ f = \id}  & 
