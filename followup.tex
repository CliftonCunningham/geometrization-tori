...
With reference to Section~\ref{ssec:equivariant1}, suppose now that $H$ acts on $G$ through group homomorphisms, so $a(h)(m(g_1,g_2)) = m(a(h)(g_1), a(h)(g_2))$.
