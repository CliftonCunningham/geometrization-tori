...
\todo{Remember to check the matching paragraph in CS for T. It may have an error. The group operations are also smooth, not just the structure map? Hm. It might be okay, actually  . . . \\ -CC}
...
[Since I haven't found a good reference for descent in the non-connected case, I think I should lay out the arguments here. We use descent in this paper to pass from $C$-equivariant local systems on $G$ to local systems on $G\ab$, and thence to characters of $G\ab(\Fq)$. We also used it in our last paper in a different way. It is also lurking behind Weil sheaves ..... So, I'm going to set things up in a very general context. This section will get whittled down to  something more manageable, later.]
