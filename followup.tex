...
The character $\trace(W_\psi) : \Sp(V)\ltimes V^\sharp \to \EE^\times$ of $W_\psi$ is studied in \cite{Howe:Weil}, where is it shown that $\trace(W_\psi)$ is determined by $\psi$ and its restriction to $\Sp(V)$ and, moreover, that $\trace(W_\psi)(g,v,z) =0$ unless $v\in \ker(g-1)$, in which case $(g,v,z)$ lies in a conjugacy class intersecting $\Sp(V) \ltimes Z$. 
%
...
It is one of the main results of \cite{Gurevich-Hadani:geometric_Weil} that there is a Weil sheaf complex $\cs{W}_{\psi}$ on $\Sp(V)\ltimes V^\sharp$ such that 
\begin{equation}
...
By a simple adaptation of what in \cite{Gurevich-Hadani:geometric_Weil}*{Appendix B.1} are called the non-normalized kernels and the normalization coefficients, it is easy to geometrize the function in \eqref{Cayley} with a $\Sp(V)\ltimes V^\sharp$-equivariant irreducible Weil sheaf $\cs{K}_0$ on $S_0 \times V^\sharp$. 
