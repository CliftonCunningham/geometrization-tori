...
\CCS(G\ab) \arrow{u}[swap]{\text{full sub}} \arrow{dl}[swap]{\iso} \\
...
in particular $\gamma = (q\times q)^* \xi$.
  \[
  \begin{tikzcd}[row sep=10, column sep = 15]
...
By Lemma~\ref{lem:torsor}, this corresponds uniquely to a diagram in $\Loc(G\ab\times G\ab)$, necessarily the diagram on the left, above.
