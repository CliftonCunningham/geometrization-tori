...
In this case, it can be shown that there is a forgetful functor taking every object in $\CCS(G)$ to a Frobenius-stable character sheaf on $G$, in the sense of \cite{lusztig:85a}*{Def.~2.10}, for which the characteristic function is a character of $G(k)$.
...
Then in Section \ref{ssec:proofs}, we give proofs of the results in Section \ref{sec:noncom}, which require a development of equivariant linear character sheaves. \todo{There was a paragraph break here. Why?}
% 
