...
\[
0 \to \Hh^2(\pi_0(X)_{\bFq},\EEx)^{\Weil{}} \to \QCSiso{X} \to \Hom_\text{}(X(K),\EEx) \to 0;
\] 
...
{}  & 0 \arrow{d} & 0 \arrow{d} &  & \\ 
   & \Hh^2(X_*(T_K)_{\mathcal{I}_K},\EEx)^{\Weil{}}  \arrow{d} & \arrow{d} \Hh^2(X_*(T_K)_{\mathcal{I}_K},\EEx)^{\Weil{}} & 0 \arrow{d} & \\
...
Thus,
\[
\Hh^2(\pi_0(T)_{\bFq},\EEx)^{\Weil{}} = \Hh^2(X_*(T_K)_{\mathcal{I}_K},\EEx)^{\Weil{}}.
\] 
...
\Aut_\QCS{T}(\cs{F}) \iso (\check{T}_\ell)^{\Weil{K}},
\]
canonically, where $\check{T}_\ell$ is the $\ell$-adic dual torus $\Hom(X_*(T_K),\EEx)$.
The case $X= \pi_0(T)$ is treated recovers the same automorphism group since $\pi_0(\pi_0(T))_{\bFq} = \pi_0(T)_{\bFq}$.
\end{proof}
...
\begin{tikzcd}
   0 \arrow{r} & \Hom(\pi_0(T)(\Fq), \EEx) \arrow{r}{\text{infl'n}} \arrow{d}{\iso}
    & \arrow{d}{\iso} \Hom_\text{}(T(K),\EEx) \arrow{r}{\text{rest'n}} & \Hom_\text{}(T^0(R),\EEx) \arrow{r} \arrow{d}{\iso} & 0\\    
    0 \arrow{r}  
 & \Hh^1(\Weil{}, \check{T}_\ell^{\mathcal{I}_K}) \arrow{r}{\text{infl'n}}
 & \Hh^1(\Weil{K}, \check{T}_\ell) \arrow{r}{\text{rest'n}} 
 & \Hh^1(\mathcal{I}_K, \check{T}_\ell)^{\Weil{}} \arrow{r}  
 & 0
\end{tikzcd}
\] 
\end{lemma}
...
\[\Hom(\pi_0(T)(\Fq), \EEx)
= \Hom((X_*(T)_{\mathcal{I}_K})^{\Weil{}}, \EEx)
= \Hom(X_*(T)_{\mathcal{I}_K}, \EEx)_{\Weil{}} 
%= \Hh^1(\Weil{}, \Hom(X_*(T), \EEx)^{\mathcal{I}_K}) 
= \Hh^1(\Weil{}, \check{T}_\ell^{\mathcal{I}_K}).
\]
...
\[
\Hom_\text{}(T^0(R),\EEx) \iso \Hh^1(\mathcal{I}_K, \check{T}_\ell)^{\Weil{}}
\] 
...
{}  & 0 \arrow{d} & 0 \arrow{d} &  & \\ 
   ...
   0 \arrow{r}  
 & \Hh^1(\Weil{}, \check{T}_\ell^{\mathcal{I}_K}) \arrow{r}{\text{infl'n}} \arrow{d}
 & \Hh^1(\Weil{K}, \check{T}_\ell) \arrow{r}{\text{rest'n}} \arrow{d}
 & \Hh^1(\mathcal{I}_K, \check{T}_\ell)^{\Weil{}} \arrow{r} \arrow{d}  
 & 0\\
 &  0  & 0 & 0 & 
  \end{tikzcd}
 \end{equation}
