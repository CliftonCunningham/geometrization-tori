...
{}  & 0 \arrow{d} & 0 \arrow{d} &  & \\ 
 ...
 &  0  & 0 & 0 & 
  \end{tikzcd}
 \]
Moreover, for $\cs{E}\in \QCS(\pi_0(T))$, $\cs{F}\in {\QCS(T)}$ and $\cs{F}^0\in {\QCS(T^0)}$, there are canonical isomorphisms
\[
...
\] 
Also by Theorem~\ref{thm:CSXK}, $\Aut(\cs{F})  \iso \Hom((\pi_0(X)_{\bFq})_{\Weil{}},\EEx)$, canonically.
