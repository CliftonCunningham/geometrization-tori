...
Here we also see the importance of working with Weil sheaves: without them, we would not be able to geometrize the character of the étale group scheme $\ZZ$ over $\FF_q$ given by $1\mapsto \ell$, for example.
...
sheaf on the Greenberg transform of the N\'eron model.  In Theorem~\ref{thm:QCXK}, we translate our results from the earlier sections
to give a description of the categories of 
