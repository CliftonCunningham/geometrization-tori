...
\begin{abstract}
  ...
  $G$ over $\mathbb{F}_q$ and exhibit a canonical isomorphism between the character group of $G(\mathbb{F}_q)$ and the group of isomorphism classes of quasicharacter sheaves on $G$.
   \end{abstract}
...
we give isomorphisms between $\QCiso{G}$, $\Hh^1(\Weil{}, \Hom(G(\bFq), \EEx))$ and $\Hom(G(\Fq), \EEx)$, where $\Weil{}$ is the Weil group for $\Fq$.
