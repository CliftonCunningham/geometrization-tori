...
such as $\Qp^\times$; in fact, aiming at such characters informs our choice of the term ``quasicharacter sheaf'' here.  Indeed, in \cite{cunningham-roe:13a} we use this paper to geometrize and categorify all quasicharacters of all algebraic tori over all local fields. 
