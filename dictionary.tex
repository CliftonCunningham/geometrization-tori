...
Thus, it is enough to prove Corollary~\ref{cor:bounded}
for \'etale group schemes $G$.

Now suppose $G$ is an etale group scheme over $\Fq$.
Let $\cs{L}$ be a character sheaf on $G$.
$[\alpha \oplus \beta \oplus 0]\in H^2(E)$.
 $b : \bG \to \EEx$ be a function 
...
Corollary~\ref{cor:bounded} shows that the full subcategory
