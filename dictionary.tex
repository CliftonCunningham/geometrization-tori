...
\cite{boyarchenko-drinfeld:06a}*{Lemma~1.10}, though in the more restrictive case of connected algebraic groups.
\end{remark}
...
\section{Applications to quasicharacters of \texorpdfstring{$p$}{p}-adic tori and Abelian varieties}\label{sec:applications}
...
%see also \cite{suzuki:14a}. The monoidal category of character sheaves on $\Gr^R_n(\Gm{R})$ is
