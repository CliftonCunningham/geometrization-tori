...
in which case it is not difficult to relate Frobenius-stable character sheaves to our character sheaves (\S \ref{ssec:alg_groups}). The new features that we have found pertaining to Weil sheaves and the non-triviality of $\Hh^2(\pi_0(\bG),\EEx)^{\Weil{}}$ do not arise in that context.
...
bounded.
On the other hand, if  the character $\chi : \ZZ \to \EEx$ of $G(\Fq)$ determined by $\chi(1) = 1+\ell$.
