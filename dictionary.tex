...
As an application, we study character sheaves on Greenberg transforms of locally finite type N\'eron models of algebraic tori over local fields. 
This provides a geometrization of quasicharacters of $p$-adic tori.
\end{abstract}
...
geometrization of quasicharacters of $p$-adic tori. 
...
Combining this with the paragraph above gives the following instance of the geometrization of the transfer of quasicharacters.
