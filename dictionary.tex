...
finite fields, local fields, algebraic tori, N\'eron models, Greenberg functor, quasicharacters, quasicharacter sheaves.}
...
\section{Character sheaves for smooth commutative group schemes}\label{sec:main}
...
\section{Quasicharacter sheaves for $p$-adic tori}\label{sec:applications}
