...
We now introduce a tool which will help us understand isomorphism classes of objects in $\QCiso{G}$ and $\lQCiso{G}$.
...
\subsection{\texorpdfstring{$S$ and $T$}{S and T}}
