...
Although the category of quasicharacter sheaves on commutative smooth group schemes $G$ over finite fields does specialize to  
that common notion when $G$ is connected and of finite type, that notion is not appropriate if one wishes to extend the dictionary to commutative smooth group schemes over finite fields. 
...
%
 ...
 Then $(\pi_! \EE)\psi$ is a quasicharacter sheaf on $G$ and
 $(\pi_! \EE)\psi\vert_{G^0} \iso (\pi_! \EE)\psi$.
\end{proof}
